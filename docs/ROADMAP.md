...
- **Submachine codegen.** IR + analyzer already lower submachine references; codegen-c emits no-op. Implement per Doc 04 §15 — instance-per-reference machine + `send EVENT to <submachine-instance>` wiring.
